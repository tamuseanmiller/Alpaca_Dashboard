...
package net.jacobpeterson.domain.alpaca.marketdata.streaming.authorization;
...
public class AuthorizationMessage
    extends MarketDataStreamStatusMessage
    implements Serializable
{
    ...
    private final static long serialVersionUID = -7529832414207467872L;
