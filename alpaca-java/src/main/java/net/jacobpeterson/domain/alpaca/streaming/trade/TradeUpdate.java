...
import net.jacobpeterson.alpaca.enums.streaming.TradeUpdateEvent;
...
public class TradeUpdate implements Serializable
{
    ...
    @Expose
    private Order order;
    private final static long serialVersionUID = -5140330095100239675L;
     ...
     * @param order
     */
    public TradeUpdate(TradeUpdateEvent event, String price, ZonedDateTime timestamp, String positionQty, Order order) {
        super();
        this.event = event;
        this.price = price;
