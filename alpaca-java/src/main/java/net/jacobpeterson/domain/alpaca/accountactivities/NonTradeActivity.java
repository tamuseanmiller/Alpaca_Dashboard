    ...
    implements Serializable
{
    ...
    private final static long serialVersionUID = -2994067561913289005L;
     ...
     * @param status
     */
    public NonTradeActivity(ActivityType activityType, String id, String date, String netAmount, String symbol, String qty, String perShareAmount, String description, String status) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((super.equals(rhs)&&((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date))))&&((this.symbol == rhs.symbol)||((this.symbol!= null)&&this.symbol.equals(rhs.symbol))))&&((this.perShareAmount == rhs.perShareAmount)||((this.perShareAmount!= null)&&this.perShareAmount.equals(rhs.perShareAmount))))&&((this.netAmount == rhs.netAmount)||((this.netAmount!= null)&&this.netAmount.equals(rhs.netAmount))))&&((this.qty == rhs.qty)||((this.qty!= null)&&this.qty.equals(rhs.qty))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.activityType == rhs.activityType)||((this.activityType!= null)&&this.activityType.equals(rhs.activityType))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
