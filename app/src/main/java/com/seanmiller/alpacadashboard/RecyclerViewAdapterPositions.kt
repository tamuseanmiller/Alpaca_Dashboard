...
//                try {
//                    nodeHttpResponse = Unirest.get("https://api.polygon.io/v1/open-close/" + mData[position] +
...
//            while (true) {
            ...
            try {
                shrOwned = alpacaAPI.getOpenPositionBySymbol(mData[position])
            } catch (e: AlpacaAPIRequestException) {
                e.printStackTrace()
            }
...
//                var nodeHttpResponse: JSONObject? = null
//                try {
//                    nodeHttpResponse = Unirest.get("https://cloud.iexapis.com/stable/stock/" + mData[position] +
...
//                        try {
//                            curr = polygonAPI.getLastQuote(mData[position])
//                        } catch (e: PolygonAPIRequestException) {
//                            e.printStackTrace()
//                        }
//                        try {
//                            close = polygonAPI.getPreviousClose(mData[position], false).results[0].c.toFloat()
//                        } catch (e: PolygonAPIRequestException) {
//                            e.printStackTrace()
//                        }
//
...
//                                polygonAPI.getLastQuote(mData[position]).last.askprice.toFloat()
//                            } else {
//                                val aggs = polygonAPI.getAggregates(mData[position], 1, Timespan.DAY, lastOpenDate, lastOpenDate.plusDays(1), false).results
...
//
                ...
                // Set values
                val snapshot = alpacaAPI.getSnapshot(mData[position])
